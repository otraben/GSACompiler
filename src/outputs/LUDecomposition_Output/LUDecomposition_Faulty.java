 ...
 */
public class LUDecomposition_Faulty {
     ...
     */
    public LUDecomposition_Faulty(RealMatrix matrix) {
     ...
     * @throws NonSquareMatrixException if matrix is not square
     */
    public LUDecomposition_Faulty(RealMatrix matrix, double singularityThreshold) {
		// formal parameters
...
if (max_5.value != col_2.value) {
            ...
            luDiag_0 = new Var<Double>(Fluky.flukyDouble((double)(lu[col_2.value][col_2.value]), 0.0));
...
if (b2_0.value.getRowDimension() != m_8.value) {
		...
		while(Phi.Entry(col_14,col_15).value < Phi.Entry(m_8,m_8).value) {
			...
			while(Phi.Entry(i_27,i_28).value < Phi.Entry(m_8,m_8).value) {
                    ...
                    luICol_0 = new Var<Double>(Fluky.flukyDouble((double)(lu[Phi.Entry(i_27,i_28).value][Phi.Entry(col_14,col_15).value]), 0.5));
		...
		Output.recordProgramOutput("LUDecomposition", bp[0][0], true);
