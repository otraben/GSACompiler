	...
	public static void main(String[] args) {
		...
		while(Phi.Entry(i_0,i_10).value < 10) {
			...
			while(Phi.Entry(j_1,j_2).value < 10) {
				...
				i_3 = new Var<Integer>(Phi.Entry(i_2,i_7).value + 1);
				...
				if (j_2.value < 5) {
					...
					i_6 = Phi.If((j_2.value > 9),i_4,i_5);
					Output.record("Test4", "main", 21, "i_6", i_6.value);
				}
				i_7 = Phi.If((j_2.value < 5),i_3,i_6);
				Output.record("Test4", "main", 18, "i_7", i_7.value);
			}
			i_8 = Phi.Exit(i_2,i_7);
			Output.record("Test4", "main", 12, "i_8", i_8.value);
