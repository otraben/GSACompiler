...
public class QRDecomposition_Faulty implements java.io.Serializable {
 ...
 * ------------------------ */
   ...
   */
   ...
   public QRDecomposition_Faulty (Matrix A) {
		// formal parameters
...
i_15 = new Var<Integer>(Fluky.flukyInt(Phi.Entry(i_14,i_15).value, 0.5));
...
if (i_15.value >= j_8.value) {
		...
		Output.recordProgramOutput("QRDecomposition", X_0.value.get(0,0), true);
      return X_0.value;
   }
