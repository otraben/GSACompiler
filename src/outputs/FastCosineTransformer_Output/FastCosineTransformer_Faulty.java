 ...
 * @since 1.2
 */
public class FastCosineTransformer_Faulty implements RealTransformer, Serializable {
     ...
     * transformed data
     */
    public FastCosineTransformer_Faulty(final DctNormalization normalization) {
		// formal parameters
