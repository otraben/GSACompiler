...
if (n_2.value == 1) {       // trivial case
		...
		while(Phi.Entry(i_0,i_1).value < (Phi.Entry(n_2,n_2).value >> 1)) {
            ...
            b_0 = new Var<Double>((double)0.5 * (f[Phi.Entry(i_0,i_1).value] - f[Phi.Entry(n_2,n_2).value - Phi.Entry(i_0,i_1).value]));
		...
		Output.recordProgramOutput("FastSineTransformer", transformed[i_5.value], false);
        return transformed;
    }
}
